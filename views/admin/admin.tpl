...
<head>
  ...
  <link rel="stylesheet" href="/admin-lte/fonts.googleapis.com.css">
</head>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>某某管理系统</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          {{else}}
            <a href="#" active="{{$val.Menu.Url}}"><i class="{{$val.Menu.Icon}}"></i> <span>{{$val.Menu.Name}}</span></a>
          {{end}}
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
       <iframe src="/admin/sys/sysmenu.html" style="width:100%;border:0px;height:500px;"></iframe>
    </section>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
